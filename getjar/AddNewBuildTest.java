...
public class AddNewBuildTest {
    ...
    public void setUp() {
        ...
        driver.get(host + "/publishing/addNewBuild/?appID=75213");
    }
    ...
    public void tearDown() {
        ...
        assertEquals("After new build submit URL is incorrect", baseUrl, host + "/publishing/target/");
    ...
    public void testAmplicitySuccess() {
        driver.findElement(By.linkText("Amplicity")).click();
    ...
    public void testIOSSuccess() {
        ...
        driver.findElement(By.name("iphoneURL")).sendKeys("http://itunes.apple.com/us/app/doodle-fit/id392912231" + Utils.getRandString("") + "?mt=8");
    }
