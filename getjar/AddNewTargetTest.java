...
public class AddNewTargetTest {
    ...
    public void setUp() {
        ...
        driver.findElement(By.name("login_name")).sendKeys("info@ovao.com");
        driver.findElement(By.name("login_password")).sendKeys("zse4rfv");
    ...
    public void testSuccess() {
        ...
        driver.findElement(By.linkText("Continue to Networks »")).click();
        // Networks
        driver.findElement(By.id("el-617749")).click();
        driver.findElement(By.linkText("Include")).click();
        driver.findElement(By.linkText("Continue to Features »")).click();
        // Features
        driver.findElement(By.id("el-11")).click();
        driver.findElement(By.linkText("Include")).click();
        driver.findElement(By.linkText("Continue to Phones »")).click();
        // Phones
        driver.findElement(By.id("el-281")).click();
        driver.findElement(By.linkText("Include")).click();
        driver.findElement(By.linkText("Continue to Review »")).click();
        // Review
