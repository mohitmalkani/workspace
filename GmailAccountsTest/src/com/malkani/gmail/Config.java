...
public class Config {
	...
	public final static String TEST_ACCOUNT_FIRSTNAME="getjarqaU1";
	public final static String TEST_ACCOUNT_LASTNAME="GJQAU1";
	public final static String TEST_ACCOUNT_USERNAME ="getjarqaU1";
