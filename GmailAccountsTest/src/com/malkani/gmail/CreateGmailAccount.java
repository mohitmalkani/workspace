...
public class CreateGmailAccount {
	...
	public static void main(String[] args) throws InterruptedException {
        ...
        //driver.findElement(By.className("goog-inline-block")).click();
        driver.findElement(By.className("goog-flat-menu-button")).submit();
        ...
        driver.findElement(By.name("RecoveryEmailAddress")).sendKeys(Config.TEST_CURRENT_EMAIL);
